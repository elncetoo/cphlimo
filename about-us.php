...
<html lang="en">
	<head>
        ...
        <link href="assets/css/cform.css" rel="stylesheet">
                    ...
                    <div class="row">
                     <h2>CONTACT US:</h2>
                        ...
                        <div class="formrow">
                                ...
                                <input type="text" name="name" id="name" placeholder="Name:" required="true" size="35" style="height: 30px; ">
                                </h5>
                                <h5>
                               
                                <input type="text" name="email" id="email" placeholder="E-mail:" required="true" maxlength="80" size="35" style="height: 30px; "><br>
                                </h5>
                                <h5>
                                
                                <textarea name="message" id="message" placeholder="Write Your Message Here:" required rows="4" cols="34"></textarea>
                                </h5>
                                <input type="submit" value="Submit" class="button button5" style=" background-color: #555555; color: white; border: 2px solid white; width:107%; height: 30px; "><br><br><br>
                                </form>
                          </div>
                      </div><!-- /row -->
                </div> <!--form end--> 
